...
//        this.setBackgroundColor(Color.BLACK);
        ...
        notScrollBarBg = resources.getDrawable(R.drawable.bg_seekbar_violet);
        hasScrollBarBg = resources.getDrawable(R.drawable.bg_seekbar_sec_violet);
        mThumbLow = resources.getDrawable(R.drawable.rsb_default_thumb);
        mThumbHigh = resources.getDrawable(R.drawable.rsb_default_thumb);
