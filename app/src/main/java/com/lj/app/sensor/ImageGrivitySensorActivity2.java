...
public class ImageGrivitySensorActivity2 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagegrivity_sensor2);
        ivBg = (ImageView) findViewById(R.id.iv_bg);

        //导入assets文件夹中的文件并将其设置到背景图片控件上
//        try {
//            InputStream open = getResources().getAssets().open("school.jpg");
